...
const COL_SPAN_12_CLASS: &str = "col-span-4";
...
const TEXT_GRAY_200_CLASS: &str = "text-gray-200 text-lg";
...
fn copyright_section() -> Html {
    rsx! {
        <div class={COL_SPAN_12_CLASS}>
            <div class={TEXT_GRAY_200_CLASS}>{ "© Kevin RS, 2024. All rights reserved." }</div>
        </div>
    }
}
...
fn socials_section() -> Html {
    let social_links: &[SocialLink] = &[SocialLink {
        href: "https://github.com/kevin-rs",
