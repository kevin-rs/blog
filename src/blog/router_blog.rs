...
pub fn ThePenguinsAreAlreadySentientYourNeuralNetworkIsJustADistraction() -> dioxus::prelude::Element
{
    ...
    rsx! {
        ...
        p {
            "(^2): Ratcliffe, J.M. et al., "
            em { "Emperor Penguin Individual Vocal Recognition in the Wild" }
            ", "
            a { href: "https://doi.org/10.1007/s00300-014-1540-5", "Polar Biology, 2014" }
        }
        p {
            "(^3): Fodor, J.A., "
        ...
        p {
            ...
            ", "
            a { href: "https://rebootingai.com/", "Pantheon Books, 2019" }
        }
        p {
            "(^6): Balda, R.P. & Kamil, A.C., "
            em { "Long-term Spatial Memory in Clark's Nutcracker" }
            ", "
            a { href: "https://doi.org/10.1016/S0003-3472(05)80137-5", "Animal Behaviour, 1992" }
        }
        p {
            "(^7): Riley, J.R. et al., "
        ...
        p {
            ...
            ", "
            a { href: "https://www.taylorfrancis.com/books/mono/10.1201/9780429089817/machines-think-pamela-mccorduck",
                "W.H. Freeman, 1979"
            }
        }
        p {
