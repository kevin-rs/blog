...
pub enum BookRoute {
    ...
    #[route("/the-penguins-are-already-sentient-your-neural-network-is-just-a-distraction")]
    ThePenguinsAreAlreadySentientYourNeuralNetworkIsJustADistraction {},
    #[route("/all-you-have-access-to-is-knowledge-and-tools-never-intelligence")]
...
impl BookRoute {
    ...
    pub fn page_id(&self) -> use_mdbook::mdbook_shared::PageId {
        match self {
            ...
            BookRoute::ThePenguinsAreAlreadySentientYourNeuralNetworkIsJustADistraction {} => {
                use_mdbook::mdbook_shared::PageId(14usize)
            }
            BookRoute::AllYouHaveAccessToIsKnowledgeAndToolsNeverIntelligence {} => {
            ...
            .push((
                14usize,
                {
                    ::use_mdbook::mdbook_shared::Page {
                        ...
                        sections: vec![
                            ::use_mdbook::mdbook_shared::Section {
                                title: "What We Mean When We Say \"Sentient\" and Why the Answer Keeps Changing"
                                    .to_string(),
                                id: "what-we-mean-when-we-say-\"sentient\"-and-why-the-answer-keeps-changing"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "The Neural Network Is Not a Theory of Mind. It Is a Theory of Curve Fitting."
                                    .to_string(),
                                id: "the-neural-network-is-not-a-theory-of-mind.-it-is-a-theory-of-curve-fitting."
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "What Embodied Intelligence Looks Like When You Actually Look at It"
                                    .to_string(),
                                id: "what-embodied-intelligence-looks-like-when-you-actually-look-at-it"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "The Distraction Is Working. Let Me Show You How."
                                    .to_string(),
                                id: "the-distraction-is-working.-let-me-show-you-how."
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "lmm as the Alternative Architecture: Building With the World Instead of About It"
                                    .to_string(),
                                id: "lmm-as-the-alternative-architecture:-building-with-the-world-instead-of-about-it"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "Stochastic Determinism: The Honest Equivalent of Neural Network Output"
                                    .to_string(),
                                id: "stochastic-determinism:-the-honest-equivalent-of-neural-network-output"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "The Philosophical Stakes Are Higher Than Anyone Is Admitting"
                                    .to_string(),
                                id: "the-philosophical-stakes-are-higher-than-anyone-is-admitting"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "What the Field Gets Wrong About Cognition, and What Getting It Right Would Look Like"
                                    .to_string(),
                                id: "what-the-field-gets-wrong-about-cognition,-and-what-getting-it-right-would-look-like"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "What a Post-Distraction Field Would Actually Build"
                                    .to_string(),
                                id: "what-a-post-distraction-field-would-actually-build"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
            ...
            .push((
                15usize,
                {
                    ::use_mdbook::mdbook_shared::Page {
                        ...
                        sections: vec![
                            ::use_mdbook::mdbook_shared::Section {
                                title: "What Knowledge Actually Is, and Why It Is Never Enough"
                                    .to_string(),
                                id: "what-knowledge-actually-is,-and-why-it-is-never-enough"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "What Tools Actually Are, and Why They Cannot Give Intelligence to Their User"
                                    .to_string(),
                                id: "what-tools-actually-are,-and-why-they-cannot-give-intelligence-to-their-user"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "The Intelligence That Was Never Stored".to_string(),
                                id: "the-intelligence-that-was-never-stored".to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "Why Retrieval Is Not Reasoning, No Matter How Fast It Is"
                                    .to_string(),
                                id: "why-retrieval-is-not-reasoning,-no-matter-how-fast-it-is"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "The Benchmark Trap: How We Trained Ourselves to Celebrate the Wrong Thing"
                                    .to_string(),
                                id: "the-benchmark-trap:-how-we-trained-ourselves-to-celebrate-the-wrong-thing"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "What Real Intelligence Would Look Like, If We Built It"
                                    .to_string(),
                                id: "what-real-intelligence-would-look-like,-if-we-built-it"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "The Gap Between Capability and Understanding."
                                    .to_string(),
                                id: "the-gap-between-capability-and-understanding."
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "Where We Go From Here, and What Honest Progress Would Look Like"
                                    .to_string(),
                                id: "where-we-go-from-here,-and-what-honest-progress-would-look-like"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
            ...
            .push((
                16usize,
                {
                    ::use_mdbook::mdbook_shared::Page {
                        ...
                        sections: vec![
                            ::use_mdbook::mdbook_shared::Section {
                                title: "The Architecture Is the Problem, Not the Scale"
                                    .to_string(),
                                id: "the-architecture-is-the-problem,-not-the-scale"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "Data Is Not Knowledge, and More Data Will Never Be Knowledge"
                                    .to_string(),
                                id: "data-is-not-knowledge,-and-more-data-will-never-be-knowledge"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "Why Pattern Matching Is Not and Cannot Become Reasoning"
                                    .to_string(),
                                id: "why-pattern-matching-is-not-and-cannot-become-reasoning"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "Neural Networks Cannot Model Other Minds and This Is Not Fixable"
                                    .to_string(),
                                id: "neural-networks-cannot-model-other-minds-and-this-is-not-fixable"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "The Data Harvesting Truth Nobody Wants to Admit"
                                    .to_string(),
                                id: "the-data-harvesting-truth-nobody-wants-to-admit"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "Why This Is Not A Property That Emerges With More Parameters"
                                    .to_string(),
                                id: "why-this-is-not-a-property-that-emerges-with-more-parameters"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
                                title: "What Should Exist Instead, and Why It Does Not"
                                    .to_string(),
                                id: "what-should-exist-instead,-and-why-it-does-not"
                                    .to_string(),
                                level: 2usize,
                            },
                            ::use_mdbook::mdbook_shared::Section {
...
#[component(no_case_check)]
pub fn ThePenguinsAreAlreadySentientYourNeuralNetworkIsJustADistraction() -> dioxus::prelude::Element
{
    use dioxus::prelude::*;
    rsx! {
        p { "Hey everyone 👋," }
        ...
        p {
            "This connects to everything I have been building toward across the last several posts. In "
            a { href: "/blogs/llms-are-usefull-lmms-will-break-reality",
                "LLMs are Useful. LMMs will Break Reality"
            }
            ", I argued that language models are locked inside a symbolic cage, describing the world without ever touching it. In "
            a { href: "/blogs/mathematical-equations-are-multimodal-by-default",
                "Mathematical Equations are Multimodal by default"
            }
            ", I argued that equations encode reality in a way that sentences never can, that mathematical structure is the most compressed and honest representation of physical truth that humans have ever produced. In "
        ...
        h2 { id: "the-neural-network-is-not-a-theory-of-mind-it-is-a-theory-of-curve-fitting",
            a {
                href: "#the-neural-network-is-not-a-theory-of-mind-it-is-a-theory-of-curve-fitting",
                class: "header",
        ...
        h2 { id: "what-embodied-intelligence-looks-like-when-you-actually-look-at-it",
            a {
                href: "#what-embodied-intelligence-looks-like-when-you-actually-look-at-it",
                class: "header",
        ...
        h2 { id: "the-distraction-is-working-let-me-show-you-how",
            a {
                href: "#the-distraction-is-working-let-me-show-you-how",
                class: "header",
        ...
        h2 { id: "lmm-as-the-alternative-architecture-building-with-the-world-instead-of-about-it",
            a {
                href: "#lmm-as-the-alternative-architecture-building-with-the-world-instead-of-about-it",
                class: "header",
        ...
        p {
            "The symbolic regression capability of lmm is the most direct implementation of the \"learn the mechanism, not the surface\" principle that I keep arguing for. When you run  "
            code { "lmm discover --iterations 200" }
            ", the system takes a set of observations, in the default case data points from a linear process, and runs a genetic programming search to find the symbolic equation that best explains those observations. The output is something like  "
            code { "(x + (1.002465056833142 + x))" }
            ", which is the system's discovered approximation of the underlying law  "
            code { "2x + 1" }
            ". The method used to find this equation is genetic programming: a population of candidate expressions is initialized, each one is evaluated for how well it fits the data, better-fitting expressions are selected and recombined and mutated, and the process iterates until either the fitness converges or the iteration budget is exhausted. This is superficially similar to neural network training in that both involve iterative optimization on data, but the difference is fundamental: the neural network optimizes parameters in a fixed architecture toward minimizing a loss, producing a black-box function; the genetic programming optimizes the structure of a symbolic expression toward explaining the data, producing a human-readable equation. The output of one is opaque. The output of the other is transparent. And transparency, as I argued in "
            a { href: "/blogs/training-is-an-evil-concept-lmms-eliminates-it-altogether",
                "Training Is an Evil Concept"
            }
            ", is not a cosmetic feature. It is the property that makes outcomes verifiable, and verification is the foundation of honest science."
        }
        CodeBlock {
            contents: "<pre style=\"background-color:#0d0d0d;\">\n<span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Discover the governing equation from synthetic linear data\n</span><span style=\"color:#f8f8f2;\">lmm discover </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">iterations </span><span style=\"color:#ff80f4;\">200\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Output: Discovered equation: (x </span><span style=\"color:#f92672;\">+ </span><span style=\"color:#f8f8f2;\">(</span><span style=\"color:#ff80f4;\">1.002465056833142 </span><span style=\"color:#f92672;\">+</span><span style=\"color:#f8f8f2;\"> x))\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> This approximates 2x </span><span style=\"color:#f92672;\">+ </span><span style=\"color:#ff80f4;\">1</span><span style=\"color:#f8f8f2;\">, discoverable </span><span style=\"color:#f92672;\">in ~</span><span style=\"color:#ff80f4;\">200 GP</span><span style=\"color:#f8f8f2;\"> iterations\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> No training corpus, no gradient descent, no unconsented data\n</span><span style=\"color:#f8f8f2;\">\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> For more complex patterns, more iterations help\n</span><span style=\"color:#f8f8f2;\">lmm discover </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">iterations </span><span style=\"color:#ff80f4;\">500 </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">data</span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\">path .</span><span style=\"color:#f92672;\">/</span><span style=\"color:#f8f8f2;\">my_observations.csv</span></pre>\n",
        }
        p {
            "The physics simulation capability directly instantiates the idea of a world model, which is what I argued animal cognition relies on rather than a lookup table of trained associations. When you run  "
            code { "lmm physics --model lorenz --steps 500 --step-size 0.01" }
            ", the system integrates the Lorenz chaotic attractor equations forward in time using the Runge-Kutta fourth-order method, producing the exact trajectory of a chaotic dynamical system from its governing equations. That trajectory is not predicted from training data. It is computed from the differential equations that describe the Lorenz system, and those equations are not learned from examples. They are specified from physical first principles and then used to generate predictions. The difference between generating predictions from learned statistical patterns and computing predictions from explicit physical laws is the difference between the curve fitter and the physics engine that I described earlier in this post. The curve fitter can only interpolate within what it has seen. The physics engine can extrapolate to states it has never simulated, because it has the generating structure, not just examples of outputs. This extrapolation capability is the thing that animal cognition has that enables animals to navigate novel environments, solve novel problems, and make decisions in situations that have no precedent in their experience."
        }
        CodeBlock {
            contents: "<pre style=\"background-color:#0d0d0d;\">\n<span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> lmm uses known physical laws, not training data, to predict the future\n</span><span style=\"color:#f8f8f2;\">lmm physics </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">model lorenz </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">steps </span><span style=\"color:#ff80f4;\">500 </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">step</span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\">size </span><span style=\"color:#ff80f4;\">0.01\n</span><span style=\"color:#f92672;\"># =&gt;</span><span style=\"color:#f8f8f2;\"> Lorenz: </span><span style=\"color:#ff80f4;\">500</span><span style=\"color:#f8f8f2;\"> steps. Final xyz: [</span><span style=\"color:#f92672;\">-</span><span style=\"color:#ff80f4;\">8.900</span><span style=\"color:#f92672;\">...</span><span style=\"color:#f8f8f2;\">, </span><span style=\"color:#f92672;\">-</span><span style=\"color:#ff80f4;\">7.413</span><span style=\"color:#f92672;\">...</span><span style=\"color:#f8f8f2;\">, </span><span style=\"color:#ff80f4;\">29.311</span><span style=\"color:#f92672;\">...</span><span style=\"color:#f8f8f2;\">]\n</span><span style=\"color:#f8f8f2;\">\n</span><span style=\"color:#f8f8f2;\">lmm physics </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">model sir </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">steps </span><span style=\"color:#ff80f4;\">1000 </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">step</span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\">size </span><span style=\"color:#ff80f4;\">0.5\n</span><span style=\"color:#f92672;\"># =&gt; </span><span style=\"color:#ff80f4;\">SIR</span><span style=\"color:#f8f8f2;\">: </span><span style=\"color:#ff80f4;\">1000</span><span style=\"color:#f8f8f2;\"> steps. Final [S,I,R]: [</span><span style=\"color:#ff80f4;\">58.797</span><span style=\"color:#f92672;\">...</span><span style=\"color:#f8f8f2;\">, </span><span style=\"color:#ff80f4;\">7.649e-15</span><span style=\"color:#f8f8f2;\">, </span><span style=\"color:#ff80f4;\">941.202</span><span style=\"color:#f92672;\">...</span><span style=\"color:#f8f8f2;\">]\n</span><span style=\"color:#f8f8f2;\">\n</span><span style=\"color:#f8f8f2;\">lmm physics </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">model pendulum </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">steps </span><span style=\"color:#ff80f4;\">300 </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">step</span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\">size </span><span style=\"color:#ff80f4;\">0.005\n</span><span style=\"color:#f8f8f2;\">\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> The equations are the world model. No training. No hallucination.\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> If the equations are right, the predictions are right. Always. Verifiably.</span></pre>\n",
        }
        p {
            "The causal reasoning layer of lmm is perhaps the most important piece for the argument I have been making about the gap between animal cognition and neural network processing, because causality is the specific kind of reasoning that animal survival most requires and that neural network pattern matching most systematically fails to provide. When a penguin learns that a specific behavior leads to food in some contexts and does not in others, it is not just learning a stimulus-response association. It is building a causal model that includes the conditions under which the association holds, and that model allows the penguin to behave appropriately in novel situations that share the relevant causal structure but not the specific sensory context. Neural networks trained to classify or predict do not, in general, learn causal models. They learn correlational patterns, and correlational patterns break down in exactly the novel situations that causal models handle correctly. The lmm causal module builds an explicit structural causal model and supports the  "
            code { "do(X=v)" }
            " intervention operator from Judea Pearl's do-calculus, which allows you to ask not just \"what is correlated with what\" but \"what would happen if I changed this variable\". That is the question that causal reasoners ask, that animal cognition answers, and that neural networks are systematically unable to address without explicit causal structure."
        }
        CodeBlock {
            contents: "<pre style=\"background-color:#0d0d0d;\">\n<span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Build a causal model and reason about interventions\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> The </span><span style=\"color:#ff80f4;\">SCM</span><span style=\"color:#f8f8f2;\"> is y </span><span style=\"color:#f92672;\">= </span><span style=\"color:#ff80f4;\">2</span><span style=\"color:#f92672;\">*</span><span style=\"color:#f8f8f2;\">x, z </span><span style=\"color:#f92672;\">=</span><span style=\"color:#f8f8f2;\"> y </span><span style=\"color:#f92672;\">+ </span><span style=\"color:#ff80f4;\">1\n</span><span style=\"color:#f8f8f2;\">lmm causal </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">intervene</span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\">node x </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">intervene</span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\">value </span><span style=\"color:#ff80f4;\">10.0\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Before intervention: x</span><span style=\"color:#f92672;\">=</span><span style=\"font-style:italic;color:#66d9ef;\">Some</span><span style=\"color:#f8f8f2;\">(</span><span style=\"color:#ff80f4;\">3.0</span><span style=\"color:#f8f8f2;\">), y</span><span style=\"color:#f92672;\">=</span><span style=\"font-style:italic;color:#66d9ef;\">Some</span><span style=\"color:#f8f8f2;\">(</span><span style=\"color:#ff80f4;\">6.0</span><span style=\"color:#f8f8f2;\">), z</span><span style=\"color:#f92672;\">=</span><span style=\"font-style:italic;color:#66d9ef;\">Some</span><span style=\"color:#f8f8f2;\">(</span><span style=\"color:#ff80f4;\">7.0</span><span style=\"color:#f8f8f2;\">)\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> After </span><span style=\"background-color:#f92672;color:#f8f8f0;\">do</span><span style=\"color:#f8f8f2;\">(x</span><span style=\"color:#f92672;\">=</span><span style=\"color:#ff80f4;\">10</span><span style=\"color:#f8f8f2;\">): x</span><span style=\"color:#f92672;\">=</span><span style=\"font-style:italic;color:#66d9ef;\">Some</span><span style=\"color:#f8f8f2;\">(</span><span style=\"color:#ff80f4;\">10.0</span><span style=\"color:#f8f8f2;\">), y</span><span style=\"color:#f92672;\">=</span><span style=\"font-style:italic;color:#66d9ef;\">Some</span><span style=\"color:#f8f8f2;\">(</span><span style=\"color:#ff80f4;\">20.0</span><span style=\"color:#f8f8f2;\">), z</span><span style=\"color:#f92672;\">=</span><span style=\"font-style:italic;color:#66d9ef;\">Some</span><span style=\"color:#f8f8f2;\">(</span><span style=\"color:#ff80f4;\">21.0</span><span style=\"color:#f8f8f2;\">)\n</span><span style=\"color:#f8f8f2;\">\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> A language model given the same question would produce a\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> plausible</span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\">sounding description of the math from training patterns.\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> lmm computes the actual causal propagation from the explicit structure.\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> The penguin navigating food sources makes exactly this kind of inference.</span></pre>\n",
        }
        p {
        ...
        h2 { id: "stochastic-determinism-the-honest-equivalent-of-neural-network-output",
            a {
                href: "#stochastic-determinism-the-honest-equivalent-of-neural-network-output",
                class: "header",
        ...
        p {
            "The way this works in practice is worth explaining carefully, because the architecture is more elegant than it might sound. When you run  "
            code { "lmm predict --text \"Wise AI built the first LMM\"" }
            ", the system runs genetic programming on the context words to discover a trajectory equation that describes how word identity changes with position, discovers a rhythm equation describing how word length evolves, and uses those equations together with a curated vocabulary mapping and a syntactic Subject-Verb-Object sentence structure to produce a deterministic text continuation. That continuation is the same every time for the same input, which is a feature rather than a bug, because it means the system's reasoning is reproducible and auditable. But when you add the  "
            code { "--stochastic" }
            " flag, a second layer activates: the  "
            code { "StochasticEnhancer" }
            ", which draws from a built-in synonym bank to replace eligible words in the deterministic output with contextually appropriate alternatives, at a replacement rate controlled by the  "
            code { "--probability" }
            " parameter. The mathematical structure of the sentence, the equation-derived skeleton, stays completely fixed. The specific surface words vary across runs according to the synonym selections. The result is an output that is unique on every run, reads with natural variety, and yet is grounded in a determinate mathematical computation that can be inspected, reproduced, and verified at any time by disabling the stochastic layer."
        }
        CodeBlock {
            contents: "<pre style=\"background-color:#0d0d0d;\">\n<span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Deterministic base output </span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\"> same every time, fully reproducible\n</span><span style=\"color:#f8f8f2;\">lmm predict </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">text </span><span style=\"color:#ffee99;\">&quot;Wise AI built the first LMM&quot;\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Output: </span><span style=\"color:#ffee99;\">&quot;Wise AI built the first LMM in the true law often long time&quot;\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\">         and a open path of an old scope is the solid order.\n</span><span style=\"color:#f8f8f2;\">\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Stochastic mode </span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\"> unique output every run, same mathematical skeleton\n</span><span style=\"color:#f8f8f2;\">lmm predict </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">text </span><span style=\"color:#ffee99;\">&quot;Wise AI built the first LMM&quot; </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">stochastic </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">probability </span><span style=\"color:#ff80f4;\">0.4\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Run </span><span style=\"color:#ff80f4;\">1</span><span style=\"color:#f8f8f2;\">: </span><span style=\"color:#ffee99;\">&quot;Wise AI built the first LMM in the genuine principle often extended time&quot;\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\">        and a accessible route of an ancient domain is the firm sequence.\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Run </span><span style=\"color:#ff80f4;\">2</span><span style=\"color:#f8f8f2;\">: </span><span style=\"color:#ffee99;\">&quot;Wise AI built the first LMM in the real law frequently long duration&quot;\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\">        and a open trajectory of an old range is the stable order.\n</span><span style=\"color:#f8f8f2;\">\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Single sentence generation with stochastic variation\n</span><span style=\"color:#f8f8f2;\">lmm sentence </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">text </span><span style=\"color:#ffee99;\">&quot;Mathematics is the language of the universe&quot; </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">stochastic\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Run </span><span style=\"color:#ff80f4;\">1</span><span style=\"color:#f8f8f2;\">: Cognition enables the dynamic significance of the world.\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Run </span><span style=\"color:#ff80f4;\">2</span><span style=\"color:#f8f8f2;\">: Analysis facilitates the continuous meaning of the cosmos.\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> The equation</span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\">derived structure is identical. Only synonyms differ.</span></pre>\n",
        }
        p {
            "The contrast with neural language model temperature sampling is in the specific thing that is being randomized, and that contrast is the whole point. When a language model applies temperature to its softmax distribution and samples a token, the randomness is operating over a learned probability distribution across the entire vocabulary, and the distribution itself is an opaque artifact of the training process. You cannot inspect the distribution and understand why certain tokens were assigned certain probabilities, because those probabilities are the accumulated result of gradient descent over billions of training examples, and the individual contributions of those examples have been averaged and compressed beyond human comprehension. The randomness is real but its source is invisible. When lmm's  "
            code { "StochasticEnhancer" }
            " replaces a word with a synonym, the randomness is operating over a curated, human-readable synonym bank that maps each eligible word to a set of alternatives with known semantic relationships. You can inspect the synonym bank, understand exactly which words are candidates for replacement, understand what semantic category each replacement belongs to, and reproduce any specific output by seeding the random number generator with a fixed value. The randomness is real but its source is completely visible, completely auditable, and completely separable from the deterministic mathematical computation that generates the underlying structure."
        }
        p {
        ...
        CodeBlock {
            contents: "<pre style=\"background-color:#0d0d0d;\">\n<span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Paragraph generation </span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\"> stochastic determinism at scale\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Same seed, same mathematical structure, different surface words each run\n</span><span style=\"color:#f8f8f2;\">lmm paragraph </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">text </span><span style=\"color:#ffee99;\">&quot;Equations reveal hidden truths about nature&quot; </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">sentences </span><span style=\"color:#ff80f4;\">6 </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">stochastic\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Run </span><span style=\"color:#ff80f4;\">1</span><span style=\"color:#f8f8f2;\">: Simulation manifests the continuous symmetry of the truths.\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\">        The symmetric wavelength connects infinity. Entropy remains</span><span style=\"color:#f92672;\">...\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Run </span><span style=\"color:#ff80f4;\">2</span><span style=\"color:#f8f8f2;\">: Modeling reveals the persistent balance of the realities.\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\">        The balanced frequency links unbounded space. Randomness sustains</span><span style=\"color:#f92672;\">...\n</span><span style=\"color:#f8f8f2;\">\n</span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> The full generation pipeline without any training\n</span><span style=\"color:#f8f8f2;\">lmm encode </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">text </span><span style=\"color:#ffee99;\">&quot;The mathematical universe&quot; </span><span style=\"color:#f92672;\">-</span><span style=\"color:#f8f8f2;\">v   </span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> encode to equation\n</span><span style=\"color:#f8f8f2;\">lmm decode </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">equation </span><span style=\"color:#ffee99;\">&quot;...&quot;                     </span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> decode back perfectly\n</span><span style=\"color:#f8f8f2;\">lmm predict </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">text </span><span style=\"color:#ffee99;\">&quot;...&quot; </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">stochastic           </span><span style=\"color:#f92672;\"># continue</span><span style=\"color:#f8f8f2;\"> stochastically\n</span><span style=\"color:#f8f8f2;\">lmm ask </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">prompt </span><span style=\"color:#ffee99;\">&quot;What is LMM?&quot; </span><span style=\"color:#f92672;\">--</span><span style=\"color:#f8f8f2;\">stochastic    </span><span style=\"color:#f92672;\">#</span><span style=\"color:#f8f8f2;\"> Q</span><span style=\"color:#f92672;\">&amp;</span><span style=\"color:#f8f8f2;\">A without retrieval</span></pre>\n",
        }
        p {
        ...
        p {
            "The moral dimension is the one I find most troubling to articulate, because making ethical arguments in a technical conversation is a reliable way to be dismissed as impractical or sentimental, and I am neither. But I wrote in "
            a { href: "/blogs/training-is-an-evil-concept-lmms-eliminates-it-altogether",
                "Training Is an Evil Concept"
            }
        ...
        h2 { id: "what-the-field-gets-wrong-about-cognition-and-what-getting-it-right-would-look-like",
            a {
                href: "#what-the-field-gets-wrong-about-cognition-and-what-getting-it-right-would-look-like",
                class: "header",
        ...
        h2 { id: "what-a-post-distraction-field-would-actually-build",
            a {
                href: "#what-a-post-distraction-field-would-actually-build",
                class: "header",
        ...
        p {
            ...
            a { href: "https://fcmconference.org/img/CambridgeDeclarationOnConsciousness.pdf",
                "Francis Crick Memorial Conference, Cambridge, 2012"
            }
        }
        p {
            ...
            ", "
            a { href: "https://doi.org/10.1111/j.1439-0310.1993.tb00445.x",
                "Ethology 94, 279–290, 1993"
            }
        }
        p {
            "(^3): Fodor, J.A., "
        ...
        p {
            ...
            a { href: "https://www.worldcat.org/isbn/9781524748258",
                "Pantheon Books, 2019, ISBN 978-1-524-74825-8"
            }
        }
        p {
            ...
            a { href: "https://doi.org/10.1016/S0003-3472(05)80302-1",
                "Animal Behaviour 44(4), 761–769, 1992"
            }
        }
        p {
            "(^7): Riley, J.R. et al., "
        ...
        p {
            ...
            ", "
            a { href: "https://archive.org/details/machineswhothink00mcco",
                "W.H. Freeman, 1979, ISBN 978-0-716-71072-1"
            }
        }
        p {
        ...
        p {
            ...
            a { href: "https://doi.org/10.1098/rstb.2014.0217",
                "Philosophical Transactions of the Royal Society B, 370(1669), 2015"
            }
        }
        p {
            "(^11): Nagel, T., "
...
#[component(no_case_check)]
pub fn AllYouHaveAccessToIsKnowledgeAndToolsNeverIntelligence() -> dioxus::prelude::Element {
    use dioxus::prelude::*;
    rsx! {
        p { "Hey everyone 👋," }
        p {
            "In my previous posts I have been building one argument from many different angles, and if you have been reading along, you already know where I keep landing. In "
            a { href: "/blogs/language-is-limited-asi-is-impossible",
                "Language is Limited. ASI is Impossible."
            }
            ", I said that words are not thoughts and that any machine trapped inside symbols is trapped inside a cage it cannot see. In "
            a { href: "/blogs/mathematical-equations-are-multimodal-by-default",
                "Mathematical Equations are Multimodal by default"
            }
            ", I argued that the only honest language for describing reality is mathematics, because equations encode mechanisms while text only encodes descriptions. In "
            a { href: "/blogs/training-is-an-evil-concept-lmms-eliminates-it-altogether",
                "Training Is an Evil Concept. LMMs Eliminates it Altogether."
            }
            ", I went further and argued that the training paradigm itself is a form of extraction that concentrates value in the wrong hands while pretending to be progress. In "
        ...
        h2 { id: "what-knowledge-actually-is-and-why-it-is-never-enough",
            a {
                href: "#what-knowledge-actually-is-and-why-it-is-never-enough",
                class: "header",
        ...
        p {
            "I want to close this section with something personal, because I promised myself I would always connect these arguments to lived experience, and I think it matters here. When I was struggling to find work after technology destroyed the career path I had been building, which I described in "
            a { href: "/blogs/technology-has-destroyed-my-livelihood",
                "Technology Has Destroyed My Livelihood"
            }
        ...
        h2 { id: "what-tools-actually-are-and-why-they-cannot-give-intelligence-to-their-user",
            a {
                href: "#what-tools-actually-are-and-why-they-cannot-give-intelligence-to-their-user",
                class: "header",
        ...
        h2 { id: "the-intelligence-that-was-never-stored",
            a {
                href: "#the-intelligence-that-was-never-stored",
                class: "header",
        ...
        h2 { id: "the-benchmark-trap-how-we-trained-ourselves-to-celebrate-the-wrong-thing",
            a {
                href: "#the-benchmark-trap-how-we-trained-ourselves-to-celebrate-the-wrong-thing",
                class: "header",
        ...
        h2 { id: "what-real-intelligence-would-look-like-if-we-built-it",
            a {
                href: "#what-real-intelligence-would-look-like-if-we-built-it",
                class: "header",
        ...
        p {
            "The first property a genuinely intelligent system would need is a generative causal model of the domain it operates in. Not a collection of associations between inputs and outputs. Not a set of retrieved documents that happen to be relevant to the query. A structural model that encodes the causal relationships between variables in the domain: how this causes that, why changing X changes Y in this specific way, what would happen if you intervened on Z. I argued in "
            a { href: "/blogs/mathematical-equations-are-multimodal-by-default",
                "Mathematical Equations are Multimodal by default"
            }
        ...
        p {
            ...
            a { href: "/blogs/announcing-kevin-rs", "I described in Announcing Kevin RS" }
            ", where the goal of the project is to build systems that can discover things that are genuinely new rather than systems that can fluently describe things that are already known. The difference between those two goals is the difference between the past and the future of AI, and I do not think the field is taking that distinction seriously enough."
        }
        p {
        ...
        p {
            "The economic consequences of the intelligence gap play out where I discussed in "
            a { href: "/blogs/as-engineers-llms-should-pay-us-for-tokens-usage",
                "As Engineers, LLMs should pay us for tokens usage"
            }
            " and "
        ...
        p {
            ...
            a { href: "https://www.ncbi.nlm.nih.gov/nlmcatalog/9505285",
                "NIH National Library of Medicine, 1994"
            }
        }
        p {
            "(^10): McCoy, R. T. et al., "
...
#[component(no_case_check)]
pub fn GenuineIntelligenceWillNeverEmergeFromNeuralNetworks() -> dioxus::prelude::Element {
    use dioxus::prelude::*;
    rsx! {
        p { "Hey everyone 👋," }
        p {
            "I have been building toward this post for a long time. Across everything I have written in this blog, I have been circling the same core question from different angles, and in each post I have gotten a little closer to saying the thing I really want to say without softening it into something that sounds more professionally acceptable. In "
            a { href: "/blogs/language-is-limited-asi-is-impossible",
                "Language is Limited. ASI is Impossible."
            }
            ", I argued that no machine trapped inside symbols can understand reality, because symbols are descriptions of the world and not the world itself. In "
            a { href: "/blogs/mathematical-equations-are-multimodal-by-default",
                "Mathematical Equations are Multimodal by default"
            }
            ", I argued that the only honest language for describing physical reality is mathematics, because equations encode mechanisms while words only encode appearances. In "
            a { href: "/blogs/training-is-an-evil-concept-lmms-eliminates-it-altogether",
                "Training Is an Evil Concept. LMMs Eliminates it Altogether."
            }
            ", I argued that the practice of extracting value from human creative work to build models without consent is not a neutral engineering choice but a moral failure. In "
            a { href: "/blogs/all-you-have-access-to-is-knowledge-and-tools-never-intelligence",
                "All You Have Access To Is Knowledge and Tools; Never Intelligence!"
            }
            ", I argued that every AI system you have ever used has access to knowledge and tools but none of them has intelligence in the sense that word deserves to carry. And in "
            a { href: "/blogs/rethinking-arc-agi", "Rethinking ARC-AGI" }
        ...
        h2 { id: "the-architecture-is-the-problem-not-the-scale",
            a {
                href: "#the-architecture-is-the-problem-not-the-scale",
                class: "header",
        ...
        h2 { id: "data-is-not-knowledge-and-more-data-will-never-be-knowledge",
            a {
                href: "#data-is-not-knowledge-and-more-data-will-never-be-knowledge",
                class: "header",
        ...
        p {
            "I want to connect this to the argument I made in "
            a { href: "/blogs/mathematical-equations-are-multimodal-by-default",
                "Mathematical Equations are Multimodal by default"
            }
        ...
        h2 { id: "why-pattern-matching-is-not-and-cannot-become-reasoning",
            a {
                href: "#why-pattern-matching-is-not-and-cannot-become-reasoning",
                class: "header",
        ...
        h2 { id: "neural-networks-cannot-model-other-minds-and-this-is-not-fixable",
            a {
                href: "#neural-networks-cannot-model-other-minds-and-this-is-not-fixable",
                class: "header",
        ...
        p {
            "There is also a deeper point here about the nature of communication itself, and I want to make it carefully because it connects to the argument I made in "
            a { href: "/blogs/language-is-limited-asi-is-impossible",
                "Language is Limited. ASI is Impossible."
            }
        ...
        h2 { id: "the-data-harvesting-truth-nobody-wants-to-admit",
            a {
                href: "#the-data-harvesting-truth-nobody-wants-to-admit",
                class: "header",
        ...
        h2 { id: "why-this-is-not-a-property-that-emerges-with-more-parameters",
            a {
                href: "#why-this-is-not-a-property-that-emerges-with-more-parameters",
                class: "header",
        ...
        h2 { id: "what-should-exist-instead-and-why-it-does-not",
            a {
                href: "#what-should-exist-instead-and-why-it-does-not",
                class: "header",
                "What Should Exist Instead, and Why It Does Not"
            }
        }
        p {
            "I want to end with what I think the alternative should look like, because I have always said that criticism is more honest when it comes paired with a direction, and I have a direction in mind. I have described it in pieces across several posts, in the argument for equations in "
            a { href: "/blogs/mathematical-equations-are-multimodal-by-default",
                "Mathematical Equations are Multimodal by default"
            }
            ", in the argument for training-free intelligence in "
            a { href: "/blogs/training-is-an-evil-concept-lmms-eliminates-it-altogether",
                "Training Is an Evil Concept. LMMs Eliminates it Altogether."
            }
            ", and in the argument for causal reasoning in "
            a { href: "/blogs/all-you-have-access-to-is-knowledge-and-tools-never-intelligence",
                "All You Have Access To Is Knowledge and Tools; Never Intelligence!"
            }
        ...
        p {
            ...
            ", P. Cole & J. Morgan (eds.), Academic Press, 1975, "
            a { href: "https://doi.org/10.1163/9789004368811_003",
