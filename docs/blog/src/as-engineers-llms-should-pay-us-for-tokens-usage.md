...
In my previous posts, I talked about [who I am](https://github.com/kevin-rs/blog/blob/main/docs/blog/src/who-am-i.md), about [the Russians killing God](https://github.com/kevin-rs/blog/blob/main/docs/blog/src/it-is-always-the-russians.md), and about [the emptiness of a life filled with suffering](https://github.com/kevin-rs/blog/blob/main/docs/blog/src/an-empty-life-filled-with-constant-suffering.md). I talked about how the most powerful AI systems in the world were built by minds trained in a godless tradition, how they took God's skin and wrapped it around a machine, and how the whole world now prays to it without knowing. Today, damn I am venting allot lately, I want to talk about something that follows directly from all of that. Something that has been sitting in my chest for months. Something that no one in this industry wants to say out loud.
